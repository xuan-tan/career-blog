...
describe('adritianDownloadContent', () => {
    const mockExecFileSync = jest.mocked(node_child_process_1.execFileSync);
    const mockExistsSync = jest.mocked(node_fs_1.default.existsSync);
    const mockMkdirSync = jest.mocked(node_fs_1.default.mkdirSync);
    const mockJoin = jest.mocked(node_path_1.default.join);
    ...
    it('should handle non-existent directories', () => {
        ...
        const mockExistsSync = jest.spyOn(node_fs_1.default, 'existsSync')
        ...
        const mockExecFileSync = jest.spyOn({ execFileSync: node_child_process_1.execFileSync }, 'execFileSync')
